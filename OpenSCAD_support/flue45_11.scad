...
module flueLoft45_11(upperDiameter, lowerDiameter, loftCeiling, loftFloor){
    union(){
        // tube
        ...
        // straight flue
        hull($fn=(20+outerTube)){
            translate([-outCut/sqrt(2), 0, -outCut/sqrt(2)]) rotate([0, 45, 0]) 
            hull(){               
